...
// ======================================================
// REMOVE LISTING HELPER
// ======================================================

async function removeListingAndCloseOffers(
    listing,
...
app.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.log(
                "Admin report notification error:",
                error.message
            );
        }
    ...
    async (req, res) => {
        ...
        if (
            ...
            try {
                ...
                await removeListingAndCloseOffers(
                    listing,
                    true
                );
...
// ======================================================
// LISTING MANAGEMENT - PAUSE / RESUME
// ======================================================
